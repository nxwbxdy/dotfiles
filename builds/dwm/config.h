...
static const char col_cyan[]        = "#e80940";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_l,      spawn,          SHCMD("wpctl set-mute @DEFAULT_AUDIO_SINK@ 1 && slock") },
	//{ MODKEY|ControlMask,           XK_l,      spawn,          {.v = lock_suspencmd } },
	{ MODKEY|ControlMask,             XK_l,      spawn,          SHCMD("wpctl set-mute @DEFAULT_AUDIO_SINK@ 1 && slock systemctl suspend") },
